                            ...
                            <div className="flex flex-col gap-4">
                                {(posterPreview || formData.poster_url) ? (
                                    <div className="relative w-32 h-48 rounded-lg overflow-hidden border border-white/20">
                                        <img src={posterPreview || formData.poster_url} className="w-full h-full object-cover" />
                                        <button
                                            type="button"
                                            onClick={() => { setPosterFile(null); setPosterPreview(null); setFormData({ ...formData, poster_url: '' }) }}
